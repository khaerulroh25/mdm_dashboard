...
$stmt = $pemiliks->getAll();
$data = $stmt->fetch(PDO::FETCH_ASSOC); // ambil semua data jadi array asosiatif
  ...
  <div class="card-body">
    <form method="POST" action="index.php?page=pemilik_edits">
      ...
      <div class="mb-3">
        ...
        <input readonly type="text" name="id_anggota" class="form-control" value ="<?= $data['id_anggota']; ?>" required>
      </div>
