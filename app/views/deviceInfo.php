...
<div class="card shadow-sm border-0">
  <div class="card-body">
    ...
    <table class="table table-bordered">
      ...
      <tr><th>Policy Aktif</th><td><?= htmlspecialchars($policyId) ?></td></tr>
    </table>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="password" id="new_pin" name="new_pin" class="form-control" required minlength="4" maxlength="6">
          </div>
        </div>
